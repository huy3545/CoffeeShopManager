...
public class CoffeeShopDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    public DbSet<HoaDonKhuyenMai> HoaDonKhuyenMais { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HoaDonKhuyenMai>()
            .HasOne(h => h.HoaDon)
            .WithMany(hd => hd.HoaDonKhuyenMais)
            .HasForeignKey(h => h.MaHD)
            .OnDelete(DeleteBehavior.Cascade);

        modelBuilder.Entity<HoaDonKhuyenMai>()
            .HasOne(h => h.KhuyenMai)
            .WithMany(km => km.HoaDonKhuyenMais)
