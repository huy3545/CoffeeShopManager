...
public class BanServiceTests
{
    ...
    public BanServiceTests()
    {
        ...
        _banService = new BanService(_mockBanRepository.Object, _mockHoaDonRepository.Object);
    }
    ...
    {
        // Arrange
        _mockBanRepository.Setup(repo => repo.GetByIdAsync(1))
            .ReturnsAsync(new Ban { MaBan = 1, TenBan = "Bàn 1", TrangThai = "Trống" });
        _mockHoaDonRepository.Setup(repo => repo.GetHoaDonsByBanAsync(1))
            .ReturnsAsync(new List<HoaDon>());
    ...
    {
        // Arrange
        _mockBanRepository.Setup(repo => repo.GetByIdAsync(999)).ReturnsAsync((Ban?)null);
